...
class PersonEncryption
{
    public static function encode(?string $data = null, ?int $expires = null, ?string $passphrase = null, ?int $coordinates = null, ?string $planet = null, ?int $passport = null): string
    {
        ...
        $payload =  $data . "/{$expiresAt}/{$user->id}/";
    ...
    public static function decode(string $token, ?string $passphrase = null, ?int $coordinates = null, ?string $planet = null, ?string $passport = null)
    {
        ...
        if (!ctype_digit($tsExpStr) || (int) $tsExpStr < time() || str_replace('/', '', $sign) !== $user->id) {
            return false;
        }
